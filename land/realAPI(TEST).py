...
# 2. DB에 저장하는 함수
def save_to_db(df, engine, table_name='real_estate'):
    if not df.empty:
...
for idx, row in df_input.iterrows():
    ...
    pageN = '1'
    numOfRows = '9999'
    year = '2016'                    # 2016(LAWD_CD:DEAL_YMD 26350 201612), 2019 X . 확인 필요함.  2017,2018, 2020, 2021,2022,2023,2024 완료, 2025년 1~3월(완료)
    if param2 == '00000':
        continue
    ...
    for i in range(1, 13):  # 0부터 12까지 포함   
